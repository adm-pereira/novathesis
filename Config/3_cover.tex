...
\nttitle(main,en){Measuring the UX and Usability of Operating Tor Relays}%
...
%-------------------------------------------------------------------
\ntauthorname(m){António Duarte Marques Esperança Pereira}{António Pereira}

%-------------------------------------------------------------------
% AUTHOR previous degree
% SYNTAX: \ntauthordegree{degree}
%-------------------------------------------------------------------
\ntauthordegree(en){BSc in Science and Computer Engineering}
...
%         You may use "\\" to force line breaks
% Advisers(s)
\ntaddperson{adviser}(a,m){Kevin Gallagher, Assistant Professor, NOVA University Lisbon}
% Co-advisers(s)
